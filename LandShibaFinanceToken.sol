...
contract LandShibaFinanceToken is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xe0b89c29B632F603C4b2D27da7908F555FE1541b);
    address payable private _marketingAddress = payable(0x6a6C70aC0516fF63484b58a5294a9fBe5cd9AFf5);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != pancakeswapV2Pair && swapEnabled && contractTokenBalance > 0) {
            ...
            if (to == pancakeswapV2Pair && from != address(pancakeswapV2Router)) {
                _redisFee = _redisFeeOnSell;
                _taxFee = _taxFeeOnSell;
            }
            
            if ((_isExcludedFromFee[from] || _isExcludedFromFee[to]) || (from != pancakeswapV2Pair && to != pancakeswapV2Pair)) {
                _redisFee = 0;
                _taxFee = 0;
            }
